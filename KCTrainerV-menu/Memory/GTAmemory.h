...
public:
	...
	static Vector3M ReadVector3M(UINT64 address);
	...
	static void WriteVector3M(UINT64 address, const Vector3M& value);
	...
	static void GetVehicleHandles(std::vector<Entity>& result, const Vector3M& position, float radius);
	static void GetVehicleHandles(std::vector<Entity>& result, const Vector3M& position, float radius, std::vector<DWORD> modelHashes);
	...
	static void GetPedHandles(std::vector<Entity>& result, const Vector3M& position, float radius);
	static void GetPedHandles(std::vector<Entity>& result, const Vector3M& position, float radius, std::vector<DWORD> modelHashes);
	...
	static void GetPropHandles(std::vector<Entity>& result, const Vector3M& position, float radius);
	static void GetPropHandles(std::vector<Entity>& result, const Vector3M& position, float radius, std::vector<DWORD> modelHashes);
	...
	static void GetEntityHandles(std::vector<Entity>& result, const Vector3M& position, float radius);
	static void GetEntityHandles(std::vector<Entity>& result, const Vector3M& position, float radius, std::vector<DWORD> modelHashes);

	static void GetCheckpointHandles(std::vector<int>& result);

	static void GetPickupObjectHandles(std::vector<int>& result);
	static void GetPickupObjectHandles(std::vector<int>& result, const Vector3M& position, float radius);
