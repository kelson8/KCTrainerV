...
// TODO Look into these, they seem useful to mess around with.
// To use these:
// SET_PED_CONFIG_FLAG(ped, ePedConfigFlags::HasHurtStarted, value {0 or 1});
