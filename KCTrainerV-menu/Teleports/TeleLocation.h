...
// TODO Reuse this in my menu, it can load and remove ipls, load props,
// boolean for if it is a online interior or offline interior, and whatever bInterior is used for.
class TeleLocation
{
public:
	std::string name;
